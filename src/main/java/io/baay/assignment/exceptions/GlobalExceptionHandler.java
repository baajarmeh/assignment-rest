...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<APIErrorResponse> handleInvalidCriteriaException(InvalidCriteriaException exception) {
		LOGGER.error(exception.getMessage());
		
		APIErrorResponse apiErrorResponse = new APIErrorResponse(
			HttpStatus.BAD_REQUEST,
			"Please validate filter criteria before sending request");
